...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    baseUrlHintExample1: 'https://api.example.com',
    baseUrlHint2: '非标准路径可填写完整地址',
    baseUrlHintExample2: 'https://api.example.com/api/v3/chat/completions',
    currentModel: '当前模型',
    ...
    defaultApiActive: '默认 API 已启用',
    defaultApiHint: '系统已配置默认 API，您可以直接使用',
    customizeConfig: '自定义配置',
    usingDefaultApi: '使用默认 API',
  ...
  en: {
    ...
    defaultApiActive: 'Default API Active',
    defaultApiHint: 'Default API is configured, ready to use',
    customizeConfig: 'Customize Configuration',
    usingDefaultApi: 'Using default API',
